...
clades<-c("A","G","I","S")
date<-"16_Sep_2019"
folderpath<-"/xxx/working_dir_for_aligns_sep2019/"
tax.acc.list<-read.csv(file="/xxx/working_dir_for_aligns_sep2019/MASTER_accession_list.csv",stringsAsFactors=FALSE)
threads<-5
path.to.mafft<-"/xxx/mafft-7.402-without-extensions/core/mafft"
path.to.gblocks<-"/xxx/Gblocks_0.91b/Gblocks"
